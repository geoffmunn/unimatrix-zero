...
import os
import argparse
from unimatrix_zero import zero3 as zero
...
def main():
    ...
    # Some basic validation of supplied data
    if cover > line_length:
        print ("Line length must be greater or equal to the 'cover' value")
        exit()

    if cover > picked:
        print ("Picked numbers must be greater or equal to the 'cover' value")
        exit()

    # Go and create the results!
